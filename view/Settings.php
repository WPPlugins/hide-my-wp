                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-12 m-b-sm">
                                <div class="checker col-md-12 ios-switch switch-md m-b-xxs p-v-xxs">
                                    ...
                                    <div class="col-md-7 no-p"><?php echo __('Show 404 Not Found Error for /wp-admin', _HMW_PLUGIN_NAME_) . "<br />" . sprintf(__("To login you have to access: %s", _HMW_PLUGIN_NAME_), '<strong>' . site_url('wp-login.php') . '</strong>');; ?></div>
                                </div>
                            </div>
